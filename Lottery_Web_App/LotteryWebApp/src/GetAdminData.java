...
/**
 * This servlet sends all the users data (except password hash) as a request to the admin_home.jsp page.
 * @author Travis Higgins
 */
@WebServlet("/GetAdminData")
public class GetAdminData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String content = "<table border='1' cellspacing='2' cellpadding='2' width='100%' align='left'>" +
                    "<tr><th>First name</th><th>Last name</th><th>Email</th><th>Phone number</th><th>Admin Status</th>" +
                    "<th>Username</th></tr>";
            ...
            // display admin_home.jsp page if successful
            RequestDispatcher dispatcher = request.getRequestDispatcher("admin/admin_home.jsp");
            request.setAttribute("userData", content);
